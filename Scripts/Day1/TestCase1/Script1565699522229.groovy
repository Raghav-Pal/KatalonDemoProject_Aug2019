...
WebUI.selectOptionByValue(findTestObject('Page_CURA Healthcare Service/input_Password_password'), 'Hongkong CURA Healthcare Center', 
    true)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Test Comments')
