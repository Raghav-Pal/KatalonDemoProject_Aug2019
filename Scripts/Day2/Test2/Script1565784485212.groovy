...
WebUI.selectOptionByValue(findTestObject('WEB/Page_CURA Healthcare Service/select_Tokyo'), 'Hongkong CURA Healthcare Center', 
    true)
...
WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/td_22'))

WebUI.setText(findTestObject('WEB/Page_CURA Healthcare Service/textarea_Comment_comment'), 'comments ')
