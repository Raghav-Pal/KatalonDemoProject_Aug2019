...
WebUI.setEncryptedText(findTestObject('WEB/Page_CURA Healthcare Service/input_Password_password'), 'g3/DOGG74jCHprihoBCU630WT95Zgs/x')
...
WebUI.selectOptionByValue(findTestObject('WEB/Page_CURA Healthcare Service/select_Tokyo CURA'), 'Hongkong CURA Healthcare Center', 
    true)
...
WebUI.click(findTestObject('WEB/Page_CURA Healthcare Service/td_21'))

WebUI.setText(findTestObject('WEB/Page_CURA Healthcare Service/textarea_Comment_comment'), 'test comments')
